...
Route::name('api.')->namespace('Api')->prefix('v1')->group(function () {
    ...
    Route::name('videos.')->prefix('videos')->namespace('Video')->group(function () {
        ...
        Route::middleware('auth:sanctum')->post('/{video}', ['uses' => 'UpdateController', 'as' => 'update']);
        ...
        // Miscellaneous
        Route::middleware('auth:sanctum')->post('/favorite/{video}', ['uses' => 'FavoriteController', 'as' => 'favorite']);
        Route::middleware('auth:sanctum')->post('/follow/{video}', ['uses' => 'FollowController', 'as' => 'follow']);
    ...
    Route::name('media.')->prefix('media')->namespace('Media')->group(function () {
        // Resources
        Route::middleware('auth:sanctum')->post('/{media}', ['uses' => 'UpdateController', 'as' => 'update']);
