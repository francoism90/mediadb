...
Route::name('api.')->namespace('Api')->prefix('v1')->group(function () {
    ...
    Route::name('media.')->prefix('media')->namespace('Media')->group(function () {
        ...
        Route::middleware('cache.headers:public;max_age=86400;etag', 'signed')->get('/asset/{media}', ['uses' => 'AssetController', 'as' => 'asset']);
    });
    ...
    Route::name('vod.')->prefix('vod')->namespace('Vod')->group(function () {
        ...
        Route::middleware('cache.headers:public;max_age=86400;etag', 'signed')->get('/sprite/{video}', ['uses' => 'SpriteController', 'as' => 'sprite']);
        Route::middleware('cache.headers:public;max_age=86400;etag', 'signed')->get('/stream/{video}', ['uses' => 'StreamController', 'as' => 'stream']);
    });
});
